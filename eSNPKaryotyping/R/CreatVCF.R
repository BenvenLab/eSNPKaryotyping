...
CreatVCF<-function(Directory,Genome_Fa,Picard_Path,GATK_Path){
  newDir = substring(Directory,3)
  Genome_Fa=substring(Genome_Fa,3)
  
  setwd(paste( "~/",newDir, sep=""))
  comm = paste("java -jar ",Picard_Path, "AddOrReplaceReadGroups.jar  I=accepted_hits.bam O=accepted_hits_rg.bam ID=\"n\" LB=\"lb\" PL=\"illumina\" PU=\"pu\" SM=\"ES\"",sep="")
  print("======================")
  print(comm)
  print("======================")
  system(comm)
  ...
  comm = paste("java -jar ",Picard_Path, "ReorderSam.jar I=",newDir, "accepted_hits_rg.bam O=",newDir, "accepted_hits_rg_sorted.bam R=",Genome_Fa, sep="")
  print("======================")
  print(comm)
  print("======================")
  system(comm)
  
  comm = paste("java -jar ",Picard_Path, "BuildBamIndex.jar I=",newDir, "accepted_hits_rg_sorted.bam", sep="")
  print("======================")
  print(comm)
  print("======================")
  system(comm)
